 ...
 *
 *  <p><b>A type conflict</b> is detected if two or more field are annotated with the same {@link Mock}
 *  and no different {@link Mock#annotatedWith} parameter are specified, or two o more equals
 *  {@link Mock#annotatedWith} parameter are specified for the same type field.</p>
 *
